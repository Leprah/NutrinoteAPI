<?php namespace App\Http\Controllers;
	...
	class AdminNutritionFoodsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Nilai Nutrisi','name'=>'value','type'=>'number','step'=>'any','validation'=>'required|numeric|min:0|max:999','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Makanan','name'=>'id_food','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'gizi_food,name'];
			//$this->form[] = ['label'=>'Nutrisi','name'=>'id_nutrition','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'gizi_nutritions,name'];
			//$this->form[] = ['label'=>'Nilai Nutrisi','name'=>'value','type'=>'number','validation'=>'required|numeric|min:1|max:99.99','width'=>'col-sm-10'];
			# OLD END FORM
